...
@section('content')
        <div class="container-fluid" style="font-size:20px;background-color:#ffff66;border:1px solid black;border-radius: 15px 15px 0px 0px;">
                <b class="fa fa-paste"> || co_style</b>
        </div>
                ...
                <form action="/style" method="post">  
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-10" style="">
                                        ...
                                        <input type="text" name="style_code" class="form-control" id="exampleInputPassword1" placeholder="style_code" style="width :20%" required>
                                        </div>
                                </div>
                        </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-10" style="">
                                        <div class="form-group">
                                        <input type="text" name="style_name" class="form-control" id="exampleInputPassword1" placeholder="style_name" style="width :20%" required>
                                        </div>
                                </div>
                        </div>
                        </div>
                        ...
                        <center>
                                ...
                                <a type="button" href="/style" class="btn btn-danger">ยกเลิก</a>                      
                        </center>            
                </form>
        </div>
        </div> <!---divend -->	
