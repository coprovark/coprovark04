...
@section('content')
        <div class="container-fluid" style="font-size:20px;background-color:#ffff66;border:1px solid black;border-radius: 15px 15px 0px 0px;">
                <b class="fa fa-paste"> || co_blood</b>
        </div>
        ...
        <div class="container" style="font-size : 15px;padding:30px 30px 30px 30px"> 
                <form action="/co_blood_register" method="post">
                        <div class="container">
                        <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-10" style="">
                                        <div class="form-group">
                                        <input type="text" name="branch_name" class="form-control" id="exampleInputPassword1" placeholder="branch_name" style="width :50%" required>
                                        </div>
                                </div>
                        </div>
                        </div>                     
                        <center>
                                ...
                                <a type="button" href="/co_blood_register" class="btn btn-danger">ยกเลิก</a>                      
                        </center>            
                </form>
        </div>
        </div> <!---divend -->	
